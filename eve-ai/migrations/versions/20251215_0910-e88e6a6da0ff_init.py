...
Revision ID: e88e6a6da0ff
Revises: 
Create Date: 2025-12-15 09:10:26.522085
...
def upgrade() -> None:
    ...
    sa.Column('model_image', sqlmodel.sql.sqltypes.AutoString(), nullable=True),
