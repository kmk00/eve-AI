...
const CharTrait = ({ name, index }: CharTraitProps) => {
  return (
    <div
      className={`relative px-2 text-center z-60 text-secondary-dark text-3xl before:content-[''] before:w-full before:h-8  before:absolute before:top-[70%] before:left-[50%] before:-translate-x-[50%] before:-z-10 before:-translate-y-[50%] before: before:bg-primary
