...
const AIChat = ({ characterId }: AIChatProps) => {
  ...
  return (
    <div className="bg-secondary-light w-full h-full pb-8 bg-cover bg-center relative after:bg-[url('/chat-bg.svg')] after:bg-cover after:bg-center after:bg-no-repeat after:w-full after:h-full after:z-10 overflow-x-hidden overflow-hidden telative">
      ...
      <div className="flex relative xl:mt-20 mt-4 z-50 px-10">
        ...
        after:absolute after:left-[50%] after:bottom-0 after:-translate-x-[50%] after:translate-y-[5%] after:-z-10 after:h-[1em] after:w-[3em] after:bg-secondary-dark after:rotate-6 after:[clip-path:polygon(0%_0%,100%_15%,90%_100%,10%_85%)]
        `}
          >
            Send
          </button>
